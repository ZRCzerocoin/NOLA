import{k as v,r as I,l as W,m as f,x as l,C as u,O as m,a3 as Oe,F as E,a as b,M as O,n as oe,E as C,H as ke,z as g,q as k,R as h,d as P,S as A,o as y,t as Ye,W as Qe,av as ye,aw as Se,ax as te,X as Xi,Q as $,ay as Ne,A as Ni,V as Yi,U as Qi,P as Ji,T as $t,a5 as ti,a6 as ii,az as Zi,a7 as Ht,aA as en}from"./index-CQyD2HdV.js";import{n as c,c as p,U,r as d,b as Oi}from"./index-C5hH9_XP.js";import{o as w}from"./if-defined-u2NVIaVh.js";import"./index-BaXqhSqh.js";import"./index-HAaF3nTx.js";import"./index-gnSwOnrm.js";import"./index-jKRyOQeh.js";import{a as Aa,W as Ia}from"./index-BxncobDl.js";import"./index-_-XboyW-.js";import"./index-CkaorizP.js";import"./index-BFuHrqV_.js";import{H as ni}from"./HelpersUtil-BWDSMcfh.js";import{E as ee}from"./ExchangeController-Ce47L59_.js";import"./index-CKx7tcQB.js";import"./index-Dt4aWdwS.js";import{M as Ct}from"./index-DnXQ_UaZ.js";import"./index-r5J2eDJy.js";import"./index-D596GLxC.js";import"./index-Lav--vea.js";import{e as oi,n as ri}from"./ref-AlzbhzMZ.js";import"./index-BQma-zo4.js";import{n as tn}from"./index-CsdCbpDG.js";import"./index-cRJS1pub.js";import"./index-DdoEd9CL.js";import"./index-Cgk_w8Km.js";import{O as St}from"./index-Bkn9yj5y.js";import{e as nn}from"./index-L1NBZr38.js";import"./index-BSey1FYM.js";import"./index-niy0Stok.js";import"./index-B90QKSKo.js";import{N as on}from"./NavigationUtil-DmfK5sOV.js";import"./index-ByBpndrm.js";const rn=v`
  :host {
    display: block;
  }
...
`;var So=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ei=class extends f{constructor(){super(...arguments),this.dappImageUrl=m.state.metadata?.icons,this.walletImageUrl=u.getAccountData()?.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await Ht.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){A.showError({message:"Something went wrong. We need to verify your account again."}),h.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await Ht.cancelSignMessage().finally(()=>this.isCancelling=!1)}};pi([d()],Lt.prototype,"isCancelling",void 0);pi([d()],Lt.prototype,"isSigning",void 0);Lt=pi([p("w3m-siwx-sign-message-view")],Lt);export{fi as AppKitAccountButton,bi as AppKitButton,yi as AppKitConnectButton,xi as AppKitNetworkButton,wi as W3mAccountButton,Ee as W3mAccountSettingsView,Gt as W3mAccountView,It as W3mAllWalletsView,mi as W3mButton,Ot as W3mChooseAccountNameView,gi as W3mConnectButton,K as W3mConnectView,Pt as W3mConnectWalletsView,ki as W3mConnectingExternalView,Wt as W3mConnectingMultiChainView,Nt as W3mConnectingWcBasicView,xe as W3mConnectingWcView,_i as W3mDownloadsView,Aa as W3mFooter,Ue as W3mFundWalletView,Wi as W3mGetWalletView,vi as W3mNetworkButton,ht as W3mNetworkSwitchView,He as W3mNetworksView,z as W3mProfileWalletsView,Ia as W3mRouter,Lt as W3mSIWXSignMessageView,Dt as W3mSwitchActiveChainView,pt as W3mUnsupportedChainView,Zt as W3mWalletCompatibleNetworksView,Ri as W3mWhatIsANetworkView,Ti as W3mWhatIsAWalletView};
